...
{
    public abstract class TarTests : FileCleanupTestBase
    {
        #region Constants

        // These constants were used by the runtime-assets
        // script to generate all the tar files.
        protected const string TestUser = "dotnet";
        protected const string TestGroup = "devdiv";

        protected const int TestMode = 484; // 744 in octal

        protected const int TestUid = 7913;
        protected const int TestGid = 3579;

        protected const string CharDevName = "chardev";
        protected const int CharDevMajor = 49;
        protected const int CharDevMinor = 86;

        protected const string BlockDevName = "blockdev";
        protected const int BlockDevMajor = 71;
        protected const int BlockDevMinor = 53;

        protected const string FifoName = "fifofile";

        protected const string TestCaseHardLink = "file_hardlink";
        protected const string TestCaseSymLink = "file_symlink";
        protected const string TestCaseLongSymlink = "file_longsymlink";
        protected const string TestCaseFolderSymlinkFolderSubFolderFile = "foldersymlink_folder_subfolder_file";
        protected const string TestCaseSpecialFiles = "specialfiles";

        protected const string TestGlobalExtendedAttributeKey = "globexthdr.MyGlobalExtendedAttribute";
        protected const string TestGlobalExtendedAttributeValue = "hello";

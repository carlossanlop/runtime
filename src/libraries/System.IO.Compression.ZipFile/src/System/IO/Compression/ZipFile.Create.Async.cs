...
public static partial class ZipFile
{
    ...
    public static Task<ZipArchive> OpenReadAsync(string archiveFileName) => OpenAsync(archiveFileName, ZipArchiveMode.Read);
    ...
    public static Task<ZipArchive> OpenAsync(string archiveFileName, ZipArchiveMode mode) => OpenAsync(archiveFileName, mode, entryNameEncoding: null);
    ...
    /// </param>
    public static async Task<ZipArchive> OpenAsync(string archiveFileName, ZipArchiveMode mode, Encoding? entryNameEncoding)
    {
        ...
        FileStream fs = new FileStream(archiveFileName, fileMode, access, fileShare, bufferSize: 0x1000, useAsync: true);
    ...
    public static Task CreateFromDirectoryAsync(string sourceDirectoryName, string destinationArchiveFileName, CancellationToken cancellationToken) =>
    ...
    /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
    public static Task CreateFromDirectoryAsync(string sourceDirectoryName, string destinationArchiveFileName, CompressionLevel compressionLevel, bool includeBaseDirectory, CancellationToken cancellationToken) =>
    ...
    public static Task CreateFromDirectoryAsync(string sourceDirectoryName, Stream destination, CancellationToken cancellationToken) =>
    ...
    public static Task CreateFromDirectoryAsync(string sourceDirectoryName, Stream destination, CompressionLevel compressionLevel, bool includeBaseDirectory, CancellationToken cancellationToken) =>
                                              ...
                                              CompressionLevel? compressionLevel, bool includeBaseDirectory, Encoding? entryNameEncoding, CancellationToken cancellationToken)
    {
        ...
        ZipArchive archive = new ZipArchive(destination, ZipArchiveMode.Create, leaveOpen: true, entryNameEncoding);
        await using (archive)
        {
            await CreateZipArchiveFromDirectoryAsync(sourceDirectoryName, archive, compressionLevel, includeBaseDirectory, cancellationToken).ConfigureAwait(false);
        }
